...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( /* Base layer */
    KC_ESC,             KC_F1,      KC_F2,      KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,                KC_PSCR, KC_SLCK, KC_PAUS,
    IT_BSLS,            IT_1,       IT_2,       IT_3,    IT_4,    IT_5,    IT_6,    TD(TD_7_LCBR),    TD(TD_8_LBRC),    TD(TD_9_RBRC),    TD(TD_0_RCBR),    IT_QUOT, IT_IGRV,   KC_BSPC,    KC_INS,  KC_HOME, KC_PGUP,    KC_NLCK, KC_PSLS, KC_PAST, KC_PMNS,
    KC_TAB,             IT_Q,       IT_W,       IT_E,    IT_R,    IT_T,    IT_Y,    IT_U,    IT_I,    IT_O,    IT_P,    IT_EGRV, IT_PLUS,               KC_DEL,  KC_END,  KC_PGDN,    KC_P7,   KC_P8,   KC_P9,   KC_PPLS,
